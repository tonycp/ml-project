"""
Clasificador de sentimiento de eventos usando reglas y keywords.
"""
...
class EventSentimentClassifier:
    """
    Clasificador de sentimiento de eventos basado en palabras clave.
    
    Determina si un evento es positivo (celebración, logro, inauguración),
    negativo (cancelación, protesta, incidente) o neutral.
    """
    ...
    def classify(self, text: str, threshold: float = 0.3) -> Tuple[EventSentiment, float]:
        """
